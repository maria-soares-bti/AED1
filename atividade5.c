...
            if (dist1 > dist2) {
                Entidade *temp = vetorEntidades[j];
                vetorEntidades[j] = vetorEntidades[j + 1];
                vetorEntidades[j + 1] = temp;
            }
        }
    }
}
...
            if (totalEntidades > 1) {
                DrawCircleLinesV(vetorEntidades[1]->pos, vetorEntidades[1]->raio + 4.0f, RED);
            }
...
            DrawText("Setas movem | ESPACO atira | N: Spawna Item | ESC sai", 10, ALTURA_JANELA - 25, 16, GRAY);
